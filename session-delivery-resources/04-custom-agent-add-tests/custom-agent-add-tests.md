...
### Talking points 🎙
1. Custom agent modes can be used specialise in certain code generation, in this case, to generate unit tests based on existing code, which can save time and ensure comprehensive test coverage.
