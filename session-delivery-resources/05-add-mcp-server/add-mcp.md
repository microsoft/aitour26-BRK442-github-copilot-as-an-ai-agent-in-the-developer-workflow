...
- [ ] **Uninstall** the Microsoft Learn MCP Server if it is already installed
...
If you want to test this, use the following prompt to demonstrate how it works within GitHub Copilot.
...
### Talking points 🎙
1. MCP Servers allow you to extend the capabilities of GitHub Copilot with powerful integrations
2. Not all models allow for tool calling and MCP integration
